...
export default function TwoPage({ data }: { data: any }) {
                                    ...
                                    >
                                        <div className="relative" id="home">
                                            <div className="relative z-10 h-screen py-28  text-center">
                                                ...
                                                <div className={`${merienda.className} flex-row items-center gap-2 justify-center font-normal text-3xl my-5`}>
                                                    <div>{config.man} ({config.nick_man})</div>
                                                    <div>&</div>
                                                    <div>{config.men} ({config.nick_men})</div>
                                                </div>
