...
export default function TeluPage({ data }: { data: any }) {
                        ...
                        {!isOpen ?
                            (
                                <div className="relative bg[[#FFF8E7]">
                                    <div className="z-10 absolute w-full h-full bg-[#DBD7D2] rotate-[30deg] origin-top-right"></div>
                                    <div className="relative z-10 h-screen flex flex-col justify-center text-center items-center">
                                        <div className="z-10 relative">
                                            ...
                                            <div className={`${dynalight.className} relative flex-row items-center font-extrabold my-5`}>
                                        ...
                                        <div className="relative" id="home">
                                            <div className="relative z-10 h-screen py-28  text-center">
                                                ...
                                                <div className="flex gap-2 justify-center">
                                                    <div className={`bg-${isBg}  text-white w-16 h-16 ${IsTem == 3 ? 'rounded-2xl' : "rounded-full"} flex flex-col items-center justify-center`}>
