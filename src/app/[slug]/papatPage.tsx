...
export default function PapatPage({ data }: { data: any }) {
            ...
            <main className={`text-${isBg} h-full m-0 overflow-hidden bg-gray-100`}>
                ...
                <div className='relative flex items-center'>
                    <div className={`${plus_jakarta_sans.className} md:hidden`}>
                        {!isOpen ?
                            (
                                <div className="relative bg-[#FFEFD5]">
                                    <div
                                        className="absolute top-0 left-0 right-0 w-full h-full bg-cover bg-center bg-no-repeat  bg-blend-multiply bg-[#DAC8AE]"
                                        style={{ backgroundImage: `url("/theme/bg/paper.jpg")` }}
                                    ></div>
                                    <div className="relative z-10 h-screen flex flex-col justify-center text-center items-center">
                                        <div className="z-10 relative w-50 h-50 mx-auto mb-10">
                                            <Image
                                                fill
                                                src={`/data/${isData}/home.jpg`}
                                                alt="home"
                                                className="object-cover rounded-full backdrop-blur-2xl"
                                            />
                                        </div>
                                        ...
                                        <button
                                            onClick={toggleOpen}
                                            className={`bg-${isBg} hover:bg-[#B8860B] flex items-center font-semibold mx-auto gap-2 bg-[#B8860B] text-white py-2 px-4 rounded-full my-3`}>
                                    ...
                                    >
                                        <div className="relative" id="home">
                                            ...
                                            <div
                                                ...
                                                style={{ backgroundImage: `url("/theme/bg/open.png")` }}
                                            ></div>
                                            <div className="relative z-10 h-screen py-28  text-center">
                                                ...
                                                <div className="relative w-40 h-48 mx-auto my-3 shadow-md rounded-br-4xl rounded-tl-4xl overflow-hidden">
                                                    <Image
                                                        src={`/data/${isData}/home.jpg`}
                                                        alt="home"
                                                        fill
                                                ...
                                                <div className="flex gap-2 justify-center">
                                                    <div className={`bg-${isBg} text-white w-16 h-16 rounded-bl-2xl rounded-tl-2xl flex flex-col items-center justify-center`}>
                                                        <span className="text-lg font-bold leading-4">{days}</span>
                                                        <span className="text-sm">Hari</span>
                                                    </div>
                                                    <div className={`bg-${isBg} text-white w-16 h-16 flex flex-col items-center justify-center`}>
                                                    ...
                                                    <div className={`bg-${isBg} text-white w-16 h-16 rounded-br-2xl rounded-tr-2xl flex flex-col items-center justify-center`}>
                                        ...
                                        <div className="relative" id="couple">
                                            <div
                                                className="absolute top-0 left-0 right-0 w-full h-full bg-cover bg-center bg-no-repeat  bg-blend-multiply bg-[#DAC8AE]"
                                                style={{ backgroundImage: `url("/theme/bg/paper.jpg")`, transform: "scaleY(-1)" }}
                                            ></div>
                                            <div className="relative z-10 py-10  text-center">
                                                <p className="text-warp text-balance mx-3 tracking-tighter">Dengan Memohon Rahmat Dan Ridho Dari Allah SWT. Kami Bermaksud Menyelenggarakan Acara
                                                    Pernikahan Kami</p>
                                                <div className="relative w-32 h-40 mx-auto my-5">
                                                    <Image
                                                        src={`/data/${isData}/men.jpg`}
                                                        alt="wanita"
                                                        fill
                                                        className="object-cover rounded-t-3xl shadow-xl"
                                                    />
                                                </div>
                                                ...
                                                <div className="relative w-32 h-40 mx-auto my-5">
                                                    <Image
                                                        ...
                                                        alt="wanita"
                                                        fill
                                                        className="object-cover rounded-b-3xl shadow-xl"
                                                    />
                                                </div>
                                                <div className="my-3">
                                        ...
                                        <div className="relative" id="date">
                                            <div
                                                className="absolute top-0 left-0 right-0 w-full h-full bg-cover bg-center bg-no-repeat  bg-blend-multiply bg-[#DAC8AE]"
                                                style={{ backgroundImage: `url("/theme/bg/paper.jpg")`, transform: "scaleX(-1)" }}
                                            ></div>
                                            <div className="relative z-10 py-40  text-center">
                                                <p className="my-3">Insya Allah Acara Akan Dilaksanakan Pada :</p>
                                                <div className="relative w-20 h-20 mx-auto my-5 overflow-hidden">
                                        ...
                                        <div className="relative" id="gallery">
                                            ...
                                            ></div>
                                            <div
                                                className="absolute top-0 left-0 right-0 w-full h-full bg-cover bg-center bg-no-repeat shadow-2xl"
                                                style={{ backgroundImage: `url("/theme/bg/open.png")` }}
                                            ></div>
                                            <div className="relative z-10 py-10  text-center">
