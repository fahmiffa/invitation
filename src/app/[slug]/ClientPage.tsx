...
export default function ClientPage({ data }: { data: any }) {
                                ...
                                (
                                    <div className="relative">
                                        ...
                                        <div className="relative z-10 h-screen flex flex-col justify-center text-center items-center">
                                            {/* <div className={` ${IsTem == 1 ? 'block' : 'hidden'} bg-${isBg} top-1/3 left-1/2 -translate-1/2 rotate-12 absolute w-40 h-60 shadow-md  backdrop-blur-md`}>
                                        </div> */}
                                            <div className="z-10 relative w-40 h-60 mx-auto mb-10 shadow-md rounded-2xl backdrop-blur-md">
                                                <Image
                                                    fill
                                            ...
                                            <div className="relative" id="home">
                                                ...
                                                <div className="relative z-10 h-screen py-28  text-center">
                                                    ...
                                                    <div className="flex gap-2 justify-center">
                                                        <div className={`bg-${isBg}  text-white w-16 h-16 ${IsTem == 1 ? 'rounded-2xl' : "rounded-full"} flex flex-col items-center justify-center`}>
    ...
    if (IsTem === 2)
        return (
            <>
                <motion.div
                    className="text-${isBg} h-full m-0 text-two"
                    ...
                    <div className='relative flex items-center'>
                        <div className={`${plus_jakarta_sans.className} md:hidden`}>
                            {!isOpen ?
                                (
                                    <div className="relative">
                                        <div className="relative z-30 h-screen flex flex-col justify-center text-center items-center">
                                            <motion.div
                                                whileHover={{ scale: 1.2 }}
                                                whileTap={{ scale: 0.8 }}
                                            >
                                                <div className="relative w-screen flex items-center justify-center mb-5">
                                                    <div className="absolute left-1/2 p-3 transform -translate-x-1/2 h-34 w-48 rotate-0 bg-two"></div>
                                                    <div className="absolute left-1/2 p-3 transform -translate-x-1/2 h-34 w-50 rotate-8 bg-[#FFF8E7] shadow-sm backdrop-blur-2xl"></div>
                                                    <div className="absolute left-2/7 -top-2.5">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                                                            <path d="m11.645 20.91-.007-.003-.022-.012a15.247 15.247 0 0 1-.383-.218 25.18 25.18 0 0 1-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0 1 12 5.052 5.5 5.5 0 0 1 16.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 0 1-4.244 3.17 15.247 15.247 0 0 1-.383.219l-.022.012-.007.004-.003.001a.752.752 0 0 1-.704 0l-.003-.001Z" />
                                                        </svg>
                                                    </div>
                                                    <div className={`${dynalight.className} relative flex-row items-center font-extrabold`}>
                                                        <div className="text-7xl leading-11">{config.nick_man}</div>
                                                        <div className="text-6xl">& {config.nick_men}</div>
                                                    </div>
                                                </div>
                                            </motion.div>
                                            <p className={`${roboto.className} text-xl font-semibold tracking-tight my-5`}>Kepada Yth. Bapak/Ibu/Saudara/i</p>
                                            <motion.div
                                                whileHover={{ scale: 1.2 }}
                                                whileTap={{ scale: 0.8 }}
                                            >
                                            ...
                                            <p className="text-pretty mb-3 text-[1rem]">Tanpa Mengurangi Rasa Hormat, Kami Mengundang Anda Untuk Hadir Di Acara Pernikahan Kami.</p>
                                            <motion.div
                                                whileHover={{ scale: 1.2 }}
                                                whileTap={{ scale: 0.8 }}
                                            >
                                ...
                                : (
                                    <AnimatePresence>
                                        ...
                                        >
                                            <div className="relative" id="home">
                                                <div className="relative z-10 h-screen py-28  text-center">
                                                    <h1 className={`${cookie.className} text-5xl`}>Save The Date</h1>
                                                    <p className={`${roboto.className} font-semibold text-balance leading-tight text-xl`}>You're invited <br></br> to the wedding of</p>
                                                    ...
                                                    <div className="flex gap-2 justify-center">
                                                        <motion.div
                                                            ...
                                                            whileTap={{ scale: 0.8 }}
                                                        >
                                                            <div className={`bg-${isBg}  text-white w-16 h-16 ${IsTem == 2 ? 'rounded-full' : "rounded-full"} flex flex-col items-center justify-center`}>
                                                                <span className="text-lg font-bold leading-4">{days}</span>
                                                                <span className="text-sm">Hari</span>
                                                            </div>
                                                        </motion.div>
                                        ...
                                        <div className={`${isLightboxOpen ? 'z-5' : 'z-50'} fixed top-10 left-2`}>
                                            {/* Tombol Musik */}
                                            <motion.div
                                                key={1}
                                                whileHover={{ scale: 1.2 }}
                            ...
                            {showNav && (
                                <>
                                    <div className={`${isLightboxOpen ? 'z-5' : 'z-50'} fixed bottom-2 left-2 -translate-y-1/2 flex items-center gap-4`}>
                                        <div className={`bg-${isBg} flex-warp gap-2  text-white backdrop-blur-md px-4 py-2 rounded-xl shadow-lg`}>
                                            {/* Home */}
                                            <a href="#home" className="p-2 rounded-md transition">
                                                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                    <path fillRule="evenodd" d="M8 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1h2a2 2 0 0 1 2 2v15a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2Zm6 1h-4v2H9a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2h-1V4Zm-6 8a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Zm1 3a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H9Z" clipRule="evenodd" />
                        ...
                        <div className={`${inter.className} hidden md:flex w-screen max-h-screen py-10 justify-center items-center overflow-hidde`}>
                            <div className="text-center mr-8">
                                <p className={`${merienda.className} text-3xl`}>
                                    The Wedding Of {config.men} & {config.man}
                                </p>
