    ...
    return (
        <div className='relative flex items-center'>
            <div className={`${plus_jakarta_sans.className} md:hidden`}>
                    ...
                    (
                        <div className="relative">
                            ...
                            <div className="relative z-10 h-screen py-10 text-black text-center">
                                <img src="https://kumengundangmu.web.id/wp-content/uploads/2025/05/Asri-Fajar-1.jpg" className="shadowm-md h-[50%] w-auto object-cover rounded-2xl shadow-md mx-auto my-3" />
                            ...
                            >
                                <div className="relative" id="home">
                                    ...
                                    <div className="relative z-10 h-screen py-30 text-black text-center">
                                        <h1 className={`${great.className} font-bold text-4xl`}>Save The Date</h1>
                                        <p className={`${roboto.className} font-semibold text-balance leading-tight text-sm`}>You're invited <br></br> to the wedding of</p>
                                        <img src="https://kumengundangmu.web.id/wp-content/uploads/2025/05/Asri-Fajar-1.jpg" className="h-[50%] w-auto object-cover rounded-2xl shadow-md mx-auto my-3" />
                                        <div className={`${merienda.className} flex items-center gap-2 justify-center font-normal text-xl`}>
                                            <div>Putra</div>
                                            <div>&</div>
                                            <div>Putri</div>
                                        </div>
                                        <p className="font-semibold text-xl my-3">Minggu, 08 Juni 2025</p>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative z-10 py-36 text-black text-center flex items-center justify-center">
                                        <p className="text-sm text-pretty mx-5 font-light tracking-tight">“Dan Diantara Tanda-tanda (Kebesaran) -Nya Ialah Dia Menciptakan Pasangan-pasangan Untukmu Dari Jenismu Sendiri, Agar Kamu Cenderung Dan Merasa Tenteram Kepadanya, Dan Dia Menjadikan Diantaramu Rasa Kasih Dan Sayang. Sungguh, Pada Yang Demikian Itu Benar-benar Terdapat Tanda-tanda (Kebesaran Allah) Bagi Kaum Yang Berfikir”
                                            `{'{Q.S : Ar-Rum : 21 } '}`  </p>
                                    </div>
                                </div>
                                <div className="relative" id="couple">
                                    ...
                                    <div className="relative z-10 py-10 text-black text-center">
                                        ...
                                        <div className="my-3">
                                            <h1 className={`${merienda.className} text-2xl`}>Asri Koryaningsih</h1>
                                ...
                                <div className="relative" id="date">
                                    ...
                                    <div className="relative z-10 py-40 text-black text-center">
                                        <p className="text-sm text-warp text-balance tracking-tighter my-3">“Insya Allah Acara Akan Dilaksanakan Pada :"</p>
                                        <img src="/cal.png" className="h-auto w-[20%] object-cover rounded-2xl shadow-md mx-auto" />
                                        <h1 className={`${cookie.className} font-bold text-3xl`}>Acara Nikah</h1>
                                        <div className="flex items-center justify-center my-3">
                                            ...
                                            <p className="text-sm text-warp text-balance tracking-tighter text-black">
                                                Minggu, 08 Juni 2025</p>
                                        </div>
                                        <div className="flex items-center justify-center mb-3">
                                            ...
                                            <p className="text-sm text-warp text-balance tracking-tighter text-black">
                                                Pukul : 13.00 WIB - Selesai</p>
                                        </div>
                                        <div className="font-bold text-sm">Bertempat </div>
                                        <p className="text-xs text-pretty mb-3">Kediaman Mempelai Wanita
                                            Desa Prapag Kidul Rt 03 Rw 03 Blok H. Muhaemin DPRD kec. losari kab. brebes</p>
                                        <h1 className={`${cookie.className} font-bold text-3xl`}>Resepsi</h1>
                                        <div className="flex items-center justify-center my-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
                                            </svg>
                                        ...
                                        <div className="font-bold text-sm">Bertempat </div>
                                        <p className="text-xs text-pretty">Kediaman Mempelai Wanita
                                            Desa Prapag Kidul Rt 03 Rw 03 Blok H. Muhaemin DPRD kec. losari kab. brebes</p>

                                        <button className="flex items-center mx-auto gap-2 bg-[#7C6533] text-white font-semibold py-2 px-4 rounded my-5">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                ...
                                <div className="relative" id="gift">
                                    ...
                                    <div className="relative z-10 py-40 text-black text-center">
                                        ...
                                        <p className="text-sm text-warp text-balance tracking-tighter my-3">“Insya Allah Acara Akan Dilaksanakan Pada :"</p>
                                        <img src="/cal.png" className="h-auto w-[20%] object-cover rounded-2xl shadow-md mx-auto" />
                                        <h1 className={`${merienda.className} font-bold text-4xl`}>Acara Nikah</h1>
                                        <div className="flex items-center justify-center my-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
                                            </svg>
                                        ...
                                        <div className="font-bold text-xl">Bertempat </div>
                                        <p className="text-sm text-warp text-balance tracking-tighter mb-3">Kediaman Mempelai Wanita
                                            Desa Prapag Kidul Rt 03 Rw 03 Blok H. Muhaemin DPRD kec. losari kab. brebes</p>
                                        <h1 className={`${merienda.className} font-bold text-4xl`}>Resepsi</h1>
                                        <div className="flex items-center justify-center my-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
                                            </svg>
                                        ...
                                        <div className="font-bold text-xl">Bertempat </div>
                                        <p className="text-sm text-warp text-balance tracking-tighter">Kediaman Mempelai Wanita
                                            Desa Prapag Kidul Rt 03 Rw 03 Blok H. Muhaemin DPRD kec. losari kab. brebes</p>
                ...
                {showNav &&
                    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-[#7C6533] text-white backdrop-blur-md px-4 py-2 rounded-xl shadow-lg z-50">
            ...
            <div className={`${inter.className} hidden md:flex w-full h-screen my-auto justify-evenly bg-gray-100 text-black items-center`}>
                <p className="text-2xl mb-6">Whereas recognition of the inherent dignity</p>
